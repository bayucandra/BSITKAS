...
void SuratTugasDaftarPegawaiDialog::InitDataView(){
...
void SuratTugasDaftarPegawaiDialog::OnCari( wxCommandEvent& event ){
    RefreshDataView();
}
void SuratTugasDaftarPegawaiDialog::RefreshDataView(){
    if(conn.connected()){
...
void SuratTugasDaftarPegawaiDialog::OnPilih( wxDataViewEvent& event ){
    Pilih();
}
void SuratTugasDaftarPegawaiDialog::Pilih(){
    if(pegawai_dataViewListCtrl->HasSelection()){
        int selected_row=pegawai_dataViewListCtrl->GetSelectedRow();
        ((SuratTugasDialog*)GetParent())->PilihPegawai(
